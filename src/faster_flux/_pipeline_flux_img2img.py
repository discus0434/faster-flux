...
def retrieve_timesteps(
    ...
    Args:
        ...
        mu (`float`, *optional*):
            The mu value used to calculate the timestep schedule. If `None`, the mu value is calculated based on the
...
class FluxImg2ImgPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    ...
    def __call__(
        ...
        # handle guidance
        guidance = (
            torch.full([1], guidance_scale, device=device, dtype=torch.float16).expand(
                latents.shape[0]
            )
